...
| Plugin | What it adds |
| --- | --- |
| [Operations](/plugins/operations) | Flight scheduling and dispatch management |
| [Attendance](/plugins/attendance) | Crew manifest logging and session tracking |
| [Quota](/plugins/quota) | Automatic quota tracking and at-risk alerts |
| [Leave](/plugins/leave) | LOA request and approval workflow |
| [Discipline](/plugins/discipline) | HR case management for strikes and suspensions |
| [Rank](/plugins/rank) | Formal promotion and demotion workflows |
